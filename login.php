    ...
    <body>
        <div>
            <form action="php-scripts/login.php" method="post">
                <div class="container">
                    <h1>LOGIN</h1>
                    <b>Email<br><br><input type="email" required name="email" size="60"><br><br>
			<b>PASSWORD</b><br><br><input type="password" required name="pass" size="60"><br><br><br><br><br>
			<!--<input type="button" value="REGISTER" onclick="">-->
			<button type="submit" name="submit" style="font-size: 14pt;cursor: pointer;"><b>LOGIN</b></button><br><br><br><br><br>
                </div>
            </form>
        </div>
